      ...
      <div className="max-w-5xl mx-auto px-4">
        {loading ? (
          ...
          <div className="relative">
            {/* Main Timeline Line */}
            <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-[2px] bg-gradient-to-b from-primary/5 via-primary/20 to-primary/5 hidden md:block" />
            ...
            <div className="space-y-16">
              {experiences.map((exp, index) => {
                ...
                return (
                  ...
                  >
                    {/* Timeline Dot/Icon */}
                    <div className="absolute left-8 md:left-1/2 md:ml-[-20px] w-10 h-10 rounded-full bg-white border-4 border-primary/20 shadow-xl flex items-center justify-center z-10 hidden md:flex overflow-hidden">
                       {exp.companyLogo ? (
                    ...
                    <div className={`w-full md:w-[45%] group`}>
                      <div className="bg-white p-6 sm:p-8 rounded-[2rem] border border-black/5 shadow-[0_10px_40px_-15px_rgba(0,0,0,0.05)] hover:shadow-[0_20px_60px_-15px_rgba(var(--primary-rgb),0.1)] transition-all duration-500 hover:-translate-y-2 relative overflow-hidden">
                        ...
                        {/* Floating Company Badge - Professional UI addition */}
                        ...
                        <div className="flex justify-between items-start mb-8 relative z-10">
                          ...
                          {/* Large Professional Logo Badge - Increased visibility */}
                    ...
                    <div className={`hidden md:block md:w-[45%] ${isEven ? 'text-right' : 'text-left'}`}>
